...
@SourceType(value = "SmartsheetARP", label = "Smartsheet",uiConfig = "smartsheet-layout.json")
public class SmartsheetConf extends AbstractArpConf<SmartsheetConf> {
  private static final String ARP_FILENAME = "arp/implementation/smartsheet-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.smartsheet.SmartsheetDriver";
